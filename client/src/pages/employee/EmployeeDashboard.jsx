            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b">
                  <th className="text-left py-2 text-gray-600">{t('emp.product')}</th>
                  <th className="text-left py-2 text-gray-600">{t('emp.brand')}</th>
                  <th className="text-left py-2 text-gray-600">{t('emp.stock')}</th>
                </tr>
              </thead>
              <tbody>
