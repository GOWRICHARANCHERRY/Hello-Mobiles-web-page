      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-fade-in-up relative z-10 gold-border">
        <div className="gold-gradient p-6 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex justify-center gap-3 mb-3">
              <Smartphone size={18} /><Tv size={18} /><Watch size={18} /><Headphones size={18} /><Laptop size={18} /><HomeIcon size={18} />
            </div>
        ...
        <div className="p-6">
          ...
          <div className="flex items-center gap-4 my-4">
            ...
            <span className="text-sm text-gray-400">or sign in with phone</span>
            <div className="flex-1 border-t border-gold-200"></div>
          </div>
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-600 text-sm">New Customer?{' '}
              <Link to="/signup" className="text-gold-600 font-semibold hover:underline">Sign Up</Link>
            </p>
          </div>

          <div className="mt-6 pt-4 border-t border-gold-200">
            <p className="text-sm font-semibold text-gray-700 mb-2 text-center">Employee & Admin Login</p>
            <p className="text-xs text-gray-500 text-center">Use your phone number and password to login. You'll be redirected to your dashboard automatically.</p>
            <div className="mt-3 bg-gold-50 rounded-lg p-3 text-xs text-gray-600">
              <p><strong>Admin:</strong> 9999999999 / admin123</p>
              <p><strong>Employee:</strong> 8888888888 / emp123</p>
            </div>
          </div>
        </div>
      </div>
