      ...
      <div className="flex-1 min-w-0 flex flex-col">
        <header className="bg-white shadow-sm px-4 py-2.5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-bold md:hidden">{t('admin.adminPanel')}</h1>
          </div>
          <Link to="/admin" className="flex items-center gap-2 px-2 py-1 rounded-lg hover:bg-gray-50 transition" title={t('admin.dashboard')}>
