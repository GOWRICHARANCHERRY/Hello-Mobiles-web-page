  ...
  if (wishlist.length === 0) {
    return (
      <div className="text-center py-16 animate-fade-in">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">{t('cust.wishlistEmpty')}</h2>
        <p className="text-gray-500 mb-6">{t('cust.saveItemsLater')}</p>
        <Link to="/products" className="bg-gold-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-gold-700 transition inline-block">{t('cust.exploreProducts')}</Link>
      </div>
    );
  }
